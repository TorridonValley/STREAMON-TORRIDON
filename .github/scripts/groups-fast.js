    ...
    if (line.startsWith('#EXTINF')) {
      ...
      if (!groups[currentGroupTitle]) {
        groups[currentGroupTitle] = [
          ...
          '# WARNING: This file is auto-generated from StreamOn-T1-FAST.m3u',
          '# Do not edit this file directly - edit the main StreamOn-T1-FAST.m3u instead',
          '#'
        ];
      }
    } else if (isInEntry) {
...
if (!filePath) {
  console.error('Please provide the path to StreamOn-T1-FAST.m3u');
  process.exit(1);
}
...
try {
  ...
  console.error('Error splitting StreamOn-T1-FAST.m3u:', error.message);
  process.exit(1);
}
