    ...
    if (line.startsWith('#EXTINF')) {
      ...
      if (!groups[currentGroupTitle]) {
        groups[currentGroupTitle] = [
          ...
          '# WARNING: This file is auto-generated from StreamOn-T1.m3u',
          '# Do not edit this file directly - edit the main StreamOn-T1.m3u instead',
          '#'
        ];
      }
    } else if (isInEntry) {
...
try {
  ...
  console.error('Error splitting StreamOn-T1.m3u:', error.message);
  process.exit(1);
}
