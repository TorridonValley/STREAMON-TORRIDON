    ...
    if (line.startsWith('#EXTINF')) {
      ...
      if (!groups[currentGroupTitle]) {
        groups[currentGroupTitle] = [
          '#EXTM3U',
          '# WARNING: This file is auto-generated from free.m3u',
          '# Do not edit this file directly - edit the main free.m3u instead',
          '#'
        ];
      }
    } else if (isInEntry) {
...
try {
  ...
  console.error('Error splitting free.m3u:', error.message);
  process.exit(1);
}
